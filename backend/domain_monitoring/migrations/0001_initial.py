# Generated by Django 4.2.7 on 2023-12-30 13:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('potential_risk', models.CharField(choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High'), ('critical', 'Critical')], max_length=255)),
                ('status', models.CharField(choices=[('open', 'Open'), ('closed', 'Closed'), ('takedown', 'Takedown Requested'), ('not_relevant', 'Not Relevant')], default='open', max_length=12)),
